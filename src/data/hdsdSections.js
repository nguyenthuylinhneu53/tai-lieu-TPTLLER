...
//   mockup        : { meta: [chuỗi hiển thị ở thanh trên khung minh hoạ], fields: [{label, tip}] }
...
const hdsdSections = [
  {
    ...
    mockup: {
      ...
      fields: [
        { label: 'Mã cán bộ', tip: 'Mã định danh nhân viên trong hệ thống. Lỗi thường gặp: nhập sai định dạng, thiếu số 0 đầu.' },
        { label: 'Mật khẩu', tip: 'Mật khẩu đăng nhập cá nhân. Lỗi thường gặp: nhập sai quá 5 lần sẽ bị khóa tài khoản, cần liên hệ quản trị để mở khóa.' },
        { label: 'Mã xác thực OTP', tip: 'Mã OTP lấy từ ứng dụng Authenticator. Lỗi thường gặp: nhập mã đã hết hạn (OTP đổi mỗi 30 giây).' },
      ],
    },
  },
  {
